...
function changeQuestion6() {
	document.getElementsByClassName("Display-Question")[0].innerHTML = "6.  Write a JavaScript program to get the integers in range (x, y)";
	document.getElementsByClassName("executing-Button")[0].onclick = rangeOfNumbers;
	document.getElementsByClassName("content_text")[0].innerText = "Enter a range of numbers with comma separation {ex: x,y } :";
	document.getElementsByClassName("content-of-question-2__textbox")[0].setAttribute("type", "text");
}
...
function changeQuestion7() {
	...
	document.getElementsByClassName("content_text")[0].innerText = "Enter a set of	elements with comma separation {ex: a,b,c } :";
	document.getElementsByClassName("content-of-question-2__textbox")[0].setAttribute("type", "text");
...
function changeQuestion8() {
	document.getElementsByClassName("Display-Question")[0].innerHTML = "8. Write a 	JavaScript program to calculate age";
